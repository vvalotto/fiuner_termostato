...
class TestClimatizador(TestCase):
    ...
    def test_evaluar_accion_temperatura_alta_sin_acumulacion(self):
    ...
    def test_evaluar_accion_temperatura_alta_de_frontera_sin_acumulacion(self):
        self._ambiente.temperatura_ambiente = 27
        self._ambiente.temperatura_deseada = 24
        self.assertEqual(self._climatizador.evaluar_accion(self._ambiente),
                         "enfriar")

    def test_evaluar_accion_temperatura_alta_de_frontera_dentro_de_histeris_sin_acumulacion(self):
        self._ambiente.temperatura_ambiente = 26
        self._ambiente.temperatura_deseada = 24
        self.assertEqual(self._climatizador.evaluar_accion(self._ambiente),
                         None)

    def test_evaluar_accion_temperatura_dentro_de_histeris_sin_acumulacion(self):
        self._ambiente.temperatura_ambiente = 24
        self._ambiente.temperatura_deseada = 24
        self.assertEqual(self._climatizador.evaluar_accion(self._ambiente),
                         None)

    def test_evaluar_accion_temperatura_baja_de_frontera_dentro_de_histeris_sin_acumulacion(self):
        self._ambiente.temperatura_ambiente = 22
        self._ambiente.temperatura_deseada = 24
        self.assertEqual(self._climatizador.evaluar_accion(self._ambiente),
                         None)

    def test_evaluar_accion_temperatura_baja_de_frontera_sin_acumulacion(self):
        self._ambiente.temperatura_ambiente = 21
        self._ambiente.temperatura_deseada = 24
        self.assertEqual(self._climatizador.evaluar_accion(self._ambiente),
                         "calentar")

    def test_evaluar_accion_temperatura_baja_sin_acumulacion(self):
    ...
    def test__acumular_funcionamiento(self):
        pass
